                    ...
                    <div class="card">
                        <div class="container" style="min-height: 400px;">
                            <div class="filter-container"
                                ...
                                <select id="brand-filter" name="brand-filter" class="form-select" style="width: auto;">
                                ...
                                <label for="phone-filter">Điện thoại</label>
                                <select id="phone-filter" name="phone-filter" class="form-select" style="width: auto;">
                                    <option value="0" selected="">Tất cả</option>
                                    <option value="1">Samsung A12</option>
                                    <option value="2">Nokia 1280</option>
                                    <option value="3">Redme 7</option>
                                    <option value="4">Oppo note 3</option>
                                    <option value="5">Xiaomi M18</option>
                                </select>
                                <label for="date-to"> Ngày </label>
                                <input class="form-select" style="width: 150px;" type="date" id="date-to" name="date-to"
                                       value="2023-05-18">
