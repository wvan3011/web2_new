...
>
  ...
  <body>
                        ...
                        <div class="modal-add-employee">
                          <form class="form" action="" method="POST">
                            <div class="add-form-wrapper">
                              ...
                              <div class="add-form--input-wrapper">
                                <input placeholder="Nhập mật khẩu của employee..." name="employee-password" type="password" class="add-form-input--password" value="<?php echo $rows['password']?>">
                              </div>
    ...
    <script>
      ...
      const passwordInput = document.querySelector('.add-form-input--password') // TODO: hash password
