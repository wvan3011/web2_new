						...
						<div class="col-lg-4 col-md-6 col-12 item">
							<article class="news-item item-style">
								...
								<div class="news-item-info">
									<div class="news-item-date">123,123 VND</div>
									<h3 class="news-item-heading item-heading">
										<a href="news-post.html" title="Benefits Of Async/Await">Product Name</a>
									</h3>
						...
						<div class="col-lg-4 col-md-6 col-12 item">
							<article class="news-item item-style">
								...
								<div class="news-item-info">
									<div class="news-item-date">123,123 VND</div>
									<h3 class="news-item-heading item-heading">
										<a href="news-post.html" title="Key Considerations Of IPaaS">Product Name</a>
									</h3>
									<div class="news-item-desc">
										<p>abc abc</p>
									</div>
						...
						<div class="col-lg-4 col-md-6 col-12 item">
							<article class="news-item item-style">
								...
								<div class="news-item-info">
									<div class="news-item-date">123,123 VND</div>
									<h3 class="news-item-heading item-heading">
										<a href="news-post.html" title="Hibernate Query Language">Product Name</a>
									</h3>
									<div class="news-item-desc">
										<p>abc abc</p>
									</div>
